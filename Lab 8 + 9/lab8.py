...
src_img=cv2.imread("source.jpg", cv2.IMREAD_COLOR)
dest_img=cv2.imread("dest.jpg", cv2.IMREAD_COLOR)
...
for i in range(10):
    ...
    cv2.imwrite("output"+str(i+1)+".jpg",interim_image)
    cv2.destroyAllWindows()

filenames = ["output.jpg", "output1.jpg", "output2.jpg", "output3.jpg", "output4.jpg", "output5.jpg", "output6.jpg", "output7.jpg", "output8.jpg", "output9.jpg", "output10.jpg"]
images = []
